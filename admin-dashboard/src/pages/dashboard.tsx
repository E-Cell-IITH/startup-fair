...
export default function StatisticsPage() {
  ...
  useEffect(() => {
    ...
    if (!fetch('https://sf-api.ecelliith.org.in/admin/api/admin/stats', {method: 'GET', credentials: 'include'})
      .then((res) => res.json())
      .then((data) => {
        setStats({
    ...
    const interval = setInterval(() => fetch('https://sf-api.ecelliith.org.in/admin/api/admin/stats', {method: 'GET', credentials: 'include'})
      .then((res) => res.json())
      .then((data) => {
        setStats({
          avgResponseTime: data.average_response_time,
